...
if __name__ == "__main__":
    ...
    wavelengths, n_complex = load_material_data("Material_Si.csv")
    ...
    num_lorentzians = 7  # Increased for better fit of metal data

    # Number of times to repeat local optimization with random initial values.
    num_repeat = 80  # Increased for better optimization
    ...
    fig.savefig("eps_fit_Si.png", dpi=150, bbox_inches="tight")
    print("Plot saved as 'eps_fit_Si.png'")
